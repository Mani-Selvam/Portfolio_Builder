...
import { Plus, Rocket, User, Info, Code, GraduationCap, FileText } from "lucide-react";
...
export default function ClientForm() {
  ...
  const [projectScreenshots, setProjectScreenshots] = useState<(File | null)[]>([]);
        ...
        <div className="max-w-md mx-auto px-4 pt-20">
          <Card className="overflow-hidden">
            <div className="bg-gradient-to-r from-accent to-emerald-600 px-6 py-8 text-white text-center">
              ...
              <p className="text-emerald-100">Your portfolio details have been received</p>
            </div>
            <CardContent className="p-6 text-center">
              <p className="text-gray-600 mb-6">
                We'll review your submission and start building your custom portfolio website. 
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card className="overflow-hidden">
          <div className="bg-gradient-to-r from-primary to-secondary px-6 py-8 text-white">
            ...
            <p className="text-blue-100">Fill in your details below and we'll build a stunning portfolio website just for you!</p>
          </div>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="border-t border-gray-200 pt-8 space-y-6">
                  ...
                  {projects.map((project, index) => (
                    <ProjectForm
                      ...
                      onScreenshotChange={(file) => updateProjectScreenshot(index, file)}
                    />
                  ))}
                </div>
                ...
                <div className="border-t border-gray-200 pt-8 space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <h4 className="font-medium text-gray-900">Education (Optional)</h4>
                      <FormField
                        control={form.control}
                        name="degree"
                        render={({ field }) => (
                    ...
                    <div className="space-y-4">
                      <h4 className="font-medium text-gray-900">Work Experience (Optional)</h4>
                      <FormField
                        control={form.control}
                        name="company"
                        render={({ field }) => (
                ...
                <div className="border-t border-gray-200 pt-8 space-y-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900">Resume & Social Links</h3>
                  </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Twitter, Instagram, Behance, etc." {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                ...
                <div className="border-t border-gray-200 pt-8">
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    >
                      {submitMutation.isPending ? "Submitting..." : "Submit Portfolio Details"}
                    </Button>
                  </div>
                </div>
              </form>
